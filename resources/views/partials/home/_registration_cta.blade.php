    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-7 mb-5 mb-lg-0">
                ...
                <a href="#" class="btn btn-primary mt-4 py-2 px-4">Book Now</a> {{-- Ganti # dengan URL yang sesuai --}}
            </div>
            <div class="col-lg-5">
                <div class="card border-0">
                    ...
                    <div class="card-body rounded-bottom bg-primary p-5">
                        <form> {{-- Ganti dengan action yang sesuai --}}
                            ...
                            <div class="form-group">
                                <select class="custom-select border-0 px-4" style="height: 47px">
                                    ...
                                    <option value="2">Class 2</option> {{-- Perbaiki value jika perlu --}}
                                    <option value="3">Class 3</option> {{-- Perbaiki value jika perlu --}}
                                </select>
                            </div>
                            <div>
