<div class="container-fluid py-5">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-5">
                <img class="img-fluid rounded mb-5 mb-lg-0" src="{{ asset('img/about-1.jpg') }}"
            ...
            <div class="col-lg-7">
                ...
                <div class="row pt-2 pb-4">
                    <div class="col-6 col-md-4">
                        <img class="img-fluid rounded" src="{{ asset('img/about-2.jpg') }}" alt="About Us Image 2" />
                    </div>
                    <div class="col-6 col-md-8">
                        <ul class="list-inline m-0">
                            ...
                            <li class="py-2 border-bottom"><i class="fa fa-check text-primary mr-3"></i>Etsea et sit
                                dolor amet ipsum</li>
                            <li class="py-2 border-bottom"><i class="fa fa-check text-primary mr-3"></i>Diam dolor diam
                                elitripsum vero.</li>
                        </ul>
                    </div>
                </div>
                <a href="#" class="btn btn-primary mt-2 py-2 px-4">Learn More</a> {{-- Ganti # dengan URL yang sesuai
                --}}
            </div>
        </div>
    </div>
